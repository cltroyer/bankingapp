...
import {createDeposit, createWithdraw} from '../redux/actions'
...
function TransactionForm() {
    ...
    const handleSubmit = (e) => {
        ...
        if (transaction === 'withdraw') {
            dispatch(createWithdraw(Number(amount), account))
    ...
    return(
        <form onSubmit={handleSubmit}>
            ...
            <p>
                ...
                <input type="number" min="0" name="amount" id="amount" value={amount} onChange={
